 ...
 *
 * SYNOPSIS:  Tektronix 43xx running UTek 4.1
 *
 * DESCRIPTION:
 * This is the machine-dependent module for UTek 4.1
 * This makes top work on the following systems:
 *	Tek4319 running UTek 4.1
 *	Tek4325 running UTek 4.1
 *	Tek4337 running UTek 4.1
 *
...
#include <sys/user.h>
/*
** I don't know if this is always correct or not, but it was necessary to
** get the correct proc structure size on the Tek 4319 running UTek 4.1.
*/
#define TEKVM
#include <sys/proc.h>
#undef TEKVM
